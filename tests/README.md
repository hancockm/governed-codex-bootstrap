...
repository/process fixtures by `configs/testing/execution_v1.json`.
...
| `test_research.py` | Verifies immutable text/PDF intake, authorized commit-pinned Git snapshots, recursive organization, Git identity/path/limit boundaries, optional PDF dependency consent states, deterministic PDF page extraction, duplicate detection, review states, and promotion boundaries. |
