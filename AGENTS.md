...
Detailed procedures are in `docs/CORE_AGENT_WORKFLOW.md`, `docs/OWNER_SCOPED_ORCHESTRATION.md`, `docs/SOURCE_DOCUMENTATION_STYLE.md`, `docs/FEATURE_AGENT_DOCUMENTATION_STANDARD.md`, and `docs/VAULT_INFORMATION_ARCHITECTURE_STANDARD.md`. The maintained reading surface starts at `Project_Obsidian_Vault/00_Home/Project MOC.md`.
