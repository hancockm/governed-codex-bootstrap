...
an accepted cumulative Bounded Correction Light receipt when that work occurred.
Otherwise it records the Bounded Correction Light task as unused or
Primary-superseded. The Primary receipt starts from the packet baseline, and
an accepted Bounded Correction Light receipt starts from the accepted Primary
candidate.
